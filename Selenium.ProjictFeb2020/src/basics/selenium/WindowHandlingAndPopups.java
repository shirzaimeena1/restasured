...
public class WindowHandlingAndPopups {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String pagetitle;
		// how you handle windo pop ups ? interview question
	...
	// we need to get to parent hen to child 
		Set <String> WindowsHandles = driver.getWindowHandles();
		// what is different between iteraton and loop?
		//iterator will iterote until next index is present while in loop we dont have next method so if it does not find it will thruo exception
	...
	// 10 min 
		...
		//how you swith from one window to another windo?
		// we use switch to to mgo from one window to another window/
