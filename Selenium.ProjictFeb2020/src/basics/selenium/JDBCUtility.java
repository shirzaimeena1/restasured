...
public class JDBCUtility {
	...
	// Declare a private static Connection obj of Connection Class
		...
		// WE SHOULD RIGHTClick on Postgressql and go to properties and get all the above host port username pasweod information
		...
		public static void setupDBConnection() {
			try {
				connection = DriverManager.getConnection(url, userName, password);// create connection between code and DB
		...
		// this method store our result and with while loop we can print or store value in obj of array
		public static void returnResult() {
			try {
				while (resultSet.next()) {
					...
					// we use CSVwriter to write our value on it
					CSVWriter csvWriter;
					
					// change the path based on your testdatOutput folde path
					
					File file = new File(
							"C:\\Users\\shirz\\eclipse-workspace\\Selenium.ProjictFeb2020\\testdataOutput\\book.csv");
					try {
